...
export class OperacaoService {
  ...
  getTradesInDateRange(dateRange: Date[], projection?: any): Observable<Operacao> {
    ...
    const agregation = [{type: 'ORDER_BY', value: 'date'}]
    const spec = { selection: selection , agregation: agregation,
                   projection: projection ? projection : ['this.All', 'marketType', 'marketDirection'] }
